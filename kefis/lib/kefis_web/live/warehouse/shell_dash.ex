defmodule KefisWeb.Warehouse.ShellDash do
  ...
  def render(assigns) do
    ...
    <div class="sidebar-inner px-4 pt-3">
      ...
      <ul class="nav flex-column pt-3 pt-md-0">
        ...
        <li class="nav-item">
          <a href="https://demo.themesberg.com/Kefis-pro/pages/kanban.html" target="_blank"
        ...
        <li class="nav-item">
          <a href="https://demo.themesberg.com/Kefis-pro/pages/calendar.html" target="_blank"
            class="nav-link d-flex justify-content-between">
            <span>
              <span class="sidebar-icon">
                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
        ...
        <li class="nav-item">
          <a href="https://demo.themesberg.com/Kefis-pro/pages/map.html" target="_blank"
            class="nav-link d-flex justify-content-between">
            <span>
              <span class="sidebar-icon">
                <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
            ...
            <ul class="flex-column nav">
              <li class="nav-item">
                <a class="nav-link" target="_blank"
                  href="https://themesberg.com/docs/Kefis-bootstrap-5-dashboard/components/accordions/">
    ...
    <div class="theme-settings card bg-gray-800 pt-2 collapse" id="theme-settings">
      <div class="card-body bg-gray-800 text-white pt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <a class="github-button" href="https://github.com/themesberg/Kefis-bootstrap-5-dashboard"
            data-color-scheme="no-preference: dark; light: light; dark: light;" data-icon="octicon-star"
            data-size="large" data-show-count="true"
            aria-label="Star themesberg/Kefis-bootstrap-5-dashboard on GitHub">Star</a>
        </div>
        <a href="https://themesberg.com/product/admin-dashboard/Kefis-bootstrap-5-dashboard" target="_blank"
        ...
        <div class="d-flex justify-content-center">
          <a class="me-3" href="https://themesberg.com/product/admin-dashboard/Kefis-bootstrap-5-dashboard"
            target="_blank">
            <img src="../../assets/img/technologies/bootstrap-5-logo.svg" class="image image-xs">
          </a>
          <a href="https://demo.themesberg.com/Kefis-react-dashboard/#/" target="_blank">
