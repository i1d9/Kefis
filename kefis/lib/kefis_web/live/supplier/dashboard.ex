defmodule KefisWeb.Supplier.Dashboard do
  ...
  def init_items(socket) do
    socket
    |> assign(:orders, Orders.supplier_orders(socket.assigns.supplier))
              ...
              <div class="card-header">
                <div class="row align-items-center">
                  ...
                  <div class="col text-end">
                    ...
                    <%= link  to: Routes.index_path(@socket, :list_my_orders), class: "nav-link" do%>
