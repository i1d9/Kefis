defmodule KefisWeb.Supplier.ShellDashboard do
  ...
  def render(assigns) do
    ...
    <div class="sidebar-inner px-4 pt-3">
      ...
      <%= link "Dashboard", to: Routes.index_path(@socket, :supplier_home), class: "sidebar-text" %>
              ...
              <%= link to: Routes.index_path(@socket, :list_product), class: "nav-link d-flex justify-content-between" do%>
        <span>
        ...
        <%= link to: Routes.index_path(@socket, :list_my_orders), class: "nav-link d-flex justify-content-between" do%>
        <span>
                      <span class="sidebar-icon">
        ...
        <%= link to: Routes.index_path(@socket, :list_transactions), class: "nav-link d-flex justify-content-between" do%>
        <span>
                                <span class="sidebar-icon">
