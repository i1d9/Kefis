defmodule KefisWeb.Admin.Partner.IndexLive do
  ...
  defp apply_action(socket, :partner_map, _) do
    socket
  end
  ...
  def render(assigns) do
    ...
    <%= if @live_action in [:partner_map]  do%>
    <%= live_component @socket, KefisWeb.Admin.ShellDashboardLive, id: "supplier_component",user: @user, component: KefisWeb.Admin.MapLive, component_details: %{id: "dsjkdsjk"} %>
    <% end %>
