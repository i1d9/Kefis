defmodule KefisWeb.Admin.ListView do
    ...
    <% end %>
      ...
      <div class="card-footer px-3 border-0 d-flex flex-column flex-lg-row align-items-center justify-content-between">
                  ...
                  <%= unless @page_number == 0 do %>
                                  <li class="page-item">
                                              <span class="page-link" phx-target={@myself} phx-click="previous">Previous</span>
                                          </li>
                  ...
                  <%= for {_page, index} <- Enum.with_index(@paginated_items) do%>
                        ...
                        <li class="page-item">
                            <span class="page-link" phx-target={@myself} phx-click="change_page" phx-value-index={index} ><%= index + 1%></span>
                        </li>
                        <% end %>
                  <% end %>
