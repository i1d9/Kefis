defmodule KefisWeb.Driver.DashboardNav do
  ...
  def render(assigns) do
    ...
    <%= unless assigns.description == "none" do%>
      ...
      <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
          <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page"><%= assigns.title %></li>
          </ol>
        </nav>
        <h2 class="h4"></h2>
        <p class="mb-0"><%= assigns.description %></p>
      </div>
    </div>
    <% end %>
          ...
          <li class="nav-item">
            <a href="../../index.html" class="nav-link d-flex align-items-center">
              <span class="sidebar-icon">
                <img src="" height="20" width="20" alt="Kefis">
              </span>
